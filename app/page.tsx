...
const scaleStats = [
  { icon: Users, value: "+130", label: "Clientes utilizando nossos serviços" },
  { icon: Globe2, value: "+19", label: "Países em 3 continentes" },
  { icon: Clock3, value: "+35", label: "Anos de experiência em pagamentos" },
