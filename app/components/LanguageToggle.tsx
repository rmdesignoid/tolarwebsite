...
const spanishPairs: Record<string, string> = {
  ...
  "Do terminal à estratégia": "Del terminal a la estrategia", "Mais controle sobre a operação. Mais velocidade para evoluir.": "Más control sobre la operación. Más velocidad para evolucionar.",
