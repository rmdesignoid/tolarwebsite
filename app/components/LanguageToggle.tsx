...
const englishPairs: Record<string, string> = {
  ...
  "Países na América Latina": "Countries in Latin America", "Terminais usando a solução": "Terminals using the solution",
  "Jornal Eletrônico de transações e eventos do terminal": "Electronic journal of terminal transactions and events", "Monitoração em tempo real de dispositivos e comandos remotos ao terminal": "Real-time monitoring of devices and remote terminal commands", "Gerenciamento e roteamento de transações": "Transaction management and routing", "Regras e lógica para operações": "Rules and logic for operations", "Captura e tratamento dos dados de cartões com chip certificado EMCo": "Capture and processing of EMCo-certified chip card data", "Campanhas e comunicação nos terminais": "Campaigns and communication on terminals",
  ...
  "Informe seu nome completo.": "Please enter your full name.", "Informe um e-mail corporativo válido.": "Please enter a valid business email.", "Informe o nome da empresa.": "Please enter the company name.", "Informe um telefone válido com DDD.": "Please enter a valid phone number with area code.",
  "Tente mais tarde.": "Try again later.", "Tente mais tarde. Por segurança, o formulário ficará indisponível por alguns minutos.": "Try again later. For security, the form will be unavailable for a few minutes.", "Tente mais tarde. O formulário ficará disponível novamente em alguns minutos.": "Try again later. The form will be available again in a few minutes.",
  "O envio de mensagens será ativado na hospedagem final da Tolar.": "Message delivery will be activated on Tolar's final hosting.", "Mensagem enviada com sucesso. Nossa equipe entrará em contato em breve.": "Message sent successfully. Our team will contact you soon.", "Não foi possível enviar sua mensagem agora. Tente novamente em instantes.": "We couldn't send your message right now. Please try again shortly.",
...
const spanishPairs: Record<string, string> = {
  ...
  "Países na América Latina": "Países de América Latina", "Terminais usando a solução": "Terminales que utilizan la solución",
  "Jornal Eletrônico de transações e eventos do terminal": "Diario electrónico de transacciones y eventos del terminal", "Monitoração em tempo real de dispositivos e comandos remotos ao terminal": "Monitoreo en tiempo real de dispositivos y comandos remotos del terminal", "Gerenciamento e roteamento de transações": "Gestión y enrutamiento de transacciones", "Regras e lógica para operações": "Reglas y lógica para operaciones", "Captura e tratamento dos dados de cartões com chip certificado EMCo": "Captura y procesamiento de datos de tarjetas con chip certificado EMCo", "Campanhas e comunicação nos terminais": "Campañas y comunicación en los terminales",
  ...
  "Spin-off da HST Card Technology, com mais de 35 anos de experiência no ecossistema de autoatendimento": "Spin-off de HST Card Technology, con más de 35 años de experiencia en el ecosistema de autoservicio",
  ...
  "Informe seu nome completo.": "Ingrese su nombre completo.", "Informe um e-mail corporativo válido.": "Ingrese un correo corporativo válido.", "Informe o nome da empresa.": "Ingrese el nombre de la empresa.", "Informe um telefone válido com DDD.": "Ingrese un teléfono válido con código de área.",
  "Tente mais tarde.": "Inténtelo más tarde.", "Tente mais tarde. Por segurança, o formulário ficará indisponível por alguns minutos.": "Inténtelo más tarde. Por seguridad, el formulario no estará disponible durante unos minutos.", "Tente mais tarde. O formulário ficará disponível novamente em alguns minutos.": "Inténtelo más tarde. El formulario volverá a estar disponible en unos minutos.",
  "O envio de mensagens será ativado na hospedagem final da Tolar.": "El envío de mensajes se activará en el alojamiento final de Tolar.", "Mensagem enviada com sucesso. Nossa equipe entrará em contato em breve.": "Mensaje enviado correctamente. Nuestro equipo se pondrá en contacto pronto.", "Não foi possível enviar sua mensagem agora. Tente novamente em instantes.": "No fue posible enviar su mensaje ahora. Inténtelo de nuevo en unos instantes.",
